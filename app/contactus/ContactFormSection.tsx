      ...
      <div className="max-w-[1068px] mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-[18px] mb-12">
          ...
          <div className="w-full h-[160px] sm:h-[192px] p-[20px] bg-black rounded-xl border border-neutral-800 shadow-sm flex flex-col justify-between">
            <div className="w-10 h-10 rounded-full bg-neutral-900 border border-[#D4AF37]/30 flex items-center justify-center">
              <svg className="w-5 h-5 text-[#E99A2B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
            </div>
            <div>
              <h4 
                className={`${syne.className} text-[24px] sm:text-[28px] font-bold leading-none bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] to-[#B38728] bg-clip-text text-transparent`}
              >
                Location
              </h4>
              <p 
                className={`${urbanist.className} text-base sm:text-lg font-semibold mt-2 bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] to-[#B38728] bg-clip-text text-transparent`}
              >
                New Town, Kolkata
              </p>
            </div>
